...
Partial Class Pref_Gui
    ...
    Private Sub InitializeComponent()
        ...
        Me.Tb_Custom_Action = New System.Windows.Forms.TextBox()
        Me.Lbl_Custom_Action = New System.Windows.Forms.Label()
        ...
        'Tab_Shutdown
        '
        Me.Tab_Shutdown.Controls.Add(Me.Tb_Custom_Action)
        Me.Tab_Shutdown.Controls.Add(Me.Lbl_Custom_Action)
        ...
        Me.Cbx_TypeStop.Items.AddRange(New Object() {resources.GetString("Cbx_TypeStop.Items"), resources.GetString("Cbx_TypeStop.Items1"), resources.GetString("Cbx_TypeStop.Items2"), resources.GetString("Cbx_TypeStop.Items3")})
        ...
        'Tb_Custom_Action
        '
        resources.ApplyResources(Me.Tb_Custom_Action, "Tb_Custom_Action")
        Me.Tb_Custom_Action.Name = "Tb_Custom_Action"
        Me.Pref_TlTip.SetToolTip(Me.Tb_Custom_Action, resources.GetString("Tb_Custom_Action.ToolTip"))
        '
        'Lbl_Custom_Action
        '
        resources.ApplyResources(Me.Lbl_Custom_Action, "Lbl_Custom_Action")
        Me.Lbl_Custom_Action.Name = "Lbl_Custom_Action"
        '
        'Pref_Gui
        '
    ...
    Friend WithEvents Tb_Custom_Action As TextBox
    Friend WithEvents Lbl_Custom_Action As Label
End Class
